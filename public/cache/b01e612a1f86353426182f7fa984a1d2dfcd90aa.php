...
<head>
	...
	************ -->
	...
	<link rel="stylesheet" href="<?php echo e(asset_url('admin/fonts/style.css')); ?>">

	<!-- Main css -->
	<link rel="stylesheet" href="<?php echo e(asset_url('admin/css/main.css')); ?>">

	<!-- Custom css -->
	<link rel="stylesheet" href="<?php echo e(asset_url('admin/css/custom.css')); ?>">

	<!-- *************
		************ Vendor Css Files *************
	************ -->
	<!-- Mega Menu -->
	<link rel="stylesheet" href="<?php echo e(asset_url('admin/vendor/megamenu/css/megamenu.css')); ?>">

	<!-- Search Filter JS -->
	<link rel="stylesheet" href="<?php echo e(asset_url('admin/vendor/search-filter/search-filter.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(asset_url('admin/vendor/search-filter/custom-search-filter.css')); ?>">
...
<body>
		...
		<nav class="sidebar-wrapper">
			...
			<div class="sidebar-tabs">
				...
				<div class="nav" role="tablist" aria-orientation="vertical">
					<a href="<?php echo e(site_url('admin/dashboard')); ?>" class="logo">
						<img src="<?php echo e(asset_url('admin/img/logo.svg')); ?>" alt="Yönetim Paneli">
					</a>
					<!--<a href="#tab-home" class="nav-link <?php echo e(segments(1) == 'dashboard' ? 'active' : null); ?>" id="home-tab" data-bs-toggle="tab" role="tab" aria-controls="tab-home" aria-selected="<?php echo e(segments(1) == 'dashboard' ? 'true' : 'false'); ?>">
						<i class="icon-home2"></i>
						<span class="nav-link-text">Anasayfa</span>
					</a>-->
					<a href="#tab-product" class="nav-link <?php echo e(segments(1) == 'products' ? 'active' : null); ?>" id="product-tab" data-bs-toggle="tab" role="tab" aria-controls="tab-product" aria-selected="<?php echo e(segments(1) == 'products' ? 'true' : 'false'); ?>">
				...
				<div class="tab-content">
					...
					<!-- Home tab -->
					<div class="tab-pane fade <?php echo e(segments(1) == 'dashboard' ? 'show active' : null); ?>" id="tab-home" role="tabpanel" aria-labelledby="home-tab">
						...
						<div class="sidebarMenuScroll">
							<div class="sidebar-menu">
								<ul>
									<li>
										<a href="<?php echo e(site_url('admin/dashboard')); ?>" class="<?php echo e(segments(1) == 'dashboard' ? 'current-page' : null); ?>">
											Genel Bakış
										</a>
									</li>
								</ul>
					...
					<!-- Products tab -->
					<div class="tab-pane fade <?php echo e(segments(1) == 'products' ? 'show active' : null); ?>" id="tab-product" role="tabpanel" aria-labelledby="product-tab">
						...
						<div class="sidebarMenuScroll">
							<div class="sidebar-menu">
								<ul>
									<li>
										<a href="<?php echo e(site_url('admin/products/approved')); ?>" class="<?php echo e(segments(1) == 'products' && segments(2) == 'approved' ? 'current-page' : null); ?>">
											Aktif Ürünler
										</a>
									</li>
									<li>
										<a href="<?php echo e(site_url('admin/products/create')); ?>" class="<?php echo e(segments(1) == 'products' && segments(2) == 'create' ? 'current-page' : null); ?>">
											Ürün Ekle
										</a>
									</li>
									<li>
										<a href="<?php echo e(site_url('admin/products/unapproved')); ?>" class="<?php echo e(segments(1) == 'products' && segments(2) == 'unapproved' ? 'current-page' : null); ?>">
											Çöp Kutusu
										</a>
									</li>
								</ul>
		...
		<div class="main-container">
						...
						<ul class="header-actions">
									...
									<div class="customScroll">
										<ul class="header-notifications">
											<li>
												<a href="#">
													<div class="user-img online">
														<img src="<?php echo e(asset_url('admin/img/user6.png')); ?>" alt="User">
													</div>
													<div class="details">
											...
											<li>
												<a href="#">
													<div class="user-img busy">
														<img src="<?php echo e(asset_url('admin/img/user10.png')); ?>" alt="User">
													</div>
													<div class="details">
											...
											<li>
												<a href="#">
													<div class="user-img away">
														<img src="<?php echo e(asset_url('admin/img/user21.png')); ?>" alt="User">
													</div>
													<div class="details">
											...
											<li>
												<a href="#">
													<div class="user-img busy">
														<img src="<?php echo e(asset_url('admin/img/user15.png')); ?>" alt="User">
													</div>
													<div class="details">
											...
											<li>
												<a href="#">
													<div class="user-img online">
														<img src="<?php echo e(asset_url('admin/img/user5.png')); ?>" alt="User">
													</div>
													<div class="details">
							...
							<li class="dropdown">
								<a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
									<span class="avatar">
										<img src="<?php echo e(asset_url('admin/img/user.svg')); ?>" alt="User Avatar">
								...
								<div class="dropdown-menu dropdown-menu-end md" aria-labelledby="userSettings">
									<div class="header-profile-actions">
										...
										<a href="<?php echo e(site_url('admin/logout')); ?>">
			...
			<div class="content-wrapper-scroll">
				...
				<div class="app-footer">
					&copy; Five Ajans <?php echo e(date('Y')); ?>
	...
	************* -->
	<!-- Megamenu JS -->
	<script src="<?php echo e(asset_url('admin/vendor/megamenu/js/megamenu.js')); ?>"></script>
	<script src="<?php echo e(asset_url('admin/vendor/megamenu/js/custom.js')); ?>"></script>

	<!-- Slimscroll JS -->
	<script src="<?php echo e(asset_url('admin/vendor/slimscroll/slimscroll.min.js')); ?>"></script>
	<script src="<?php echo e(asset_url('admin/vendor/slimscroll/custom-scrollbar.js')); ?>"></script>

	<!-- Search Filter JS -->
	<script src="<?php echo e(asset_url('admin/vendor/search-filter/search-filter.js')); ?>"></script>
	<script src="<?php echo e(asset_url('admin/vendor/search-filter/custom-search-filter.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\projects\plasmak\public\views/admin/layouts/main.blade.php ENDPATH**/ ?>