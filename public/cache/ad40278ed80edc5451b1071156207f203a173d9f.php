...
<?php $__env->startSection('title', '#PlasmakPerfect'); ?>
		...
		<section data-scrollax-parent="true" class="dark-bg">
			...
			<div class="container">
				...
				<div class="parallax-item fl-wrap" data-scrollax-parent="true">
					<div class="row">
						<div class="col-md-7">
							<img  src="<?php echo e(asset_url('client/images/folio/3.jpg')); ?>"   alt="">
						</div>
						...
						<div class="album-thumbnails">
							<div data-position-left2="65" data-position-top2="-5" data-scrollax="properties: { translateY: '-150px' }"><img src="<?php echo e(asset_url('client/images/folio/2.jpg')); ?>" alt="" class="respimg"></div>
							<div data-position-left2="80" data-position-top2="50" data-scrollax="properties: { translateY: '-350px' }">
								<video autoplay loop muted  class="bgvid">
									<source src="<?php echo e(asset_url('client/video/1.mp4')); ?>" type="video/mp4">
								</video>
							</div>
						</div>
					</div>
				...
				<div class="parallax-item fl-wrap" data-scrollax-parent="true">
					<div class="row">
						...
						<div class="col-md-7">
							<img  src="<?php echo e(asset_url('client/images/folio/7.jpg')); ?>"   alt="">
						</div>
						...
						<div class="album-thumbnails">
							<div data-position-left2="0" data-position-top2="0" data-scrollax="properties: { translateY: '-150px' }"><img src="<?php echo e(asset_url('client/images/folio/13.jpg')); ?>" alt="" class="respimg"></div>
							<div data-position-left2="25" data-position-top2="60" data-scrollax="properties: { translateY: '-50px' }"><img src="<?php echo e(asset_url('client/images/folio/14.jpg')); ?>" alt="" class="respimg"></div>
						</div>
					</div>
				...
				<div class="parallax-item fl-wrap" data-scrollax-parent="true">
					<div class="row">
						<div class="col-md-7">
							<img  src="<?php echo e(asset_url('client/images/folio/25.jpg')); ?>"   alt="">
						</div>
						<div class="parallax-text right-pos" data-scrollax="properties: { translateY: '-250px' }">
							<h3>
								<a href="javascript:void(0)">
						...
						<div class="album-thumbnails">
							<div data-position-left2="65" data-position-top2="0" data-scrollax="properties: { translateY: '-150px' }"><img src="<?php echo e(asset_url('client/images/folio/11.jpg')); ?>" alt="" class="respimg"></div>
							<div data-position-left2="80" data-position-top2="50" data-scrollax="properties: { translateY: '-350px' }"><img src="<?php echo e(asset_url('client/images/folio/8.jpg')); ?>" alt="" class="respimg"></div>
						</div>
					</div>
				...
				<div class="parallax-item fl-wrap" data-scrollax-parent="true">
					<div class="row">
						<div class="col-md-5"></div>
						<div class="col-md-7">
							<img  src="<?php echo e(asset_url('client/images/folio/24.jpg')); ?>"   alt="">
						</div>
						<div class="parallax-text left-pos" data-scrollax="properties: { translateY: '-250px' }">
						...
						<div class="album-thumbnails">
							<div data-position-left2="2" data-position-top2="15" data-scrollax="properties: { translateY: '-50px' }"><img src="<?php echo e(asset_url('client/images/folio/6.jpg')); ?>" alt="" class="respimg"></div>
							<div data-position-left2="28" data-position-top2="90" data-scrollax="properties: { translateY: '-150px' }"><img src="<?php echo e(asset_url('client/images/folio/15.jpg')); ?>" alt="" class="respimg"></div>
						</div>
					</div>
...
<?php echo $__env->make('client.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\plasmak\public\views/client/pages/plasmakworld/plasmak-perfect.blade.php ENDPATH**/ ?>