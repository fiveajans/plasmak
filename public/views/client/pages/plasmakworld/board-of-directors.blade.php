...
@section('content')
	...
	<div class="content">
		...
		<section class="parallax-section dark-bg sec-half parallax-sec-half-right" data-scrollax-parent="true">
			<div class="bg par-elem" data-bg="{{ asset_url('client/images/bg/2.jpg') }}" data-scrollax="properties: { translateY: '30%' }"></div>
		...
		<section data-scrollax-parent="true" id="sec1">
			<div class="section-subtitle right-pos" data-scrollax="properties: { translateY: '-250px' }"><span>//</span>Yönetim</div>
			<div class="container">
				<!-- team-box   --> 
				<div class="team-box">
					<div class="team-photo">
						<div class="overlay"></div>
						<a href="team-single.html">Daha Fazla</a>
						<img src="{{ asset_url('client/images/team/1.jpg') }}" alt="" class="respimg"> 										
					</div>
					<div class="team-info">
						<h3>David Gray</h3>
				...
				<div class="team-box">
					<div class="team-photo">
						<div class="overlay"></div>
						<a href="team-single.html">Daha Fazla</a>
						<img src="{{ asset_url('client/images/team/2.jpg') }}" alt="" class="respimg"> 										
					</div>
					<div class="team-info">
						<h3>Martin Frenze</h3>
						<h4>Co-manager associated</h4>
				...
				<div class="team-box">
					<div class="team-photo">
						<div class="overlay"></div>
						<a href="team-single.html">Daha Fazla</a>
						<img src="{{ asset_url('client/images/team/3.jpg') }}" alt="" class="respimg"> 										
					</div>
					<div class="team-info">
						<h3>Kevin Brunt</h3>
						<h4>Co-manager associated</h4>
				...
				<div class="team-box">
					<div class="team-photo">
						<div class="overlay"></div>
						<a href="team-single.html">Daha Fazla</a>
						<img src="{{ asset_url('client/images/team/4.jpg') }}" alt="" class="respimg"> 										
					</div>
					<div class="team-info">
						<h3>Austin Evon</h3>
						<h4>Co-manager associated</h4>
				...
				<div class="team-box">
					<div class="team-photo">
						<div class="overlay"></div>
						<a href="team-single.html">Daha Fazla</a>
						<img src="{{ asset_url('client/images/team/5.jpg') }}" alt="" class="respimg"> 										
					</div>
					<div class="team-info">
