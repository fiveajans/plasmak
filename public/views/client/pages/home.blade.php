			...
			<div class="half-slider-img-wrap">
				...
				<div class="half-slider-img fl-wrap full-height">
					...
					<div class="half-slider-img-item">
						<div class="bg" data-bg="{{ asset_url('client/images/bg/13.jpg') }}" data-scrollax="properties: { translateY: '250px' }"></div>
					...
					<!-- half-slider-img item -->
					<div class="half-slider-img-item">
						<div class="bg" data-bg="{{ asset_url('client/images/bg/29.jpg') }}" data-scrollax="properties: { translateY: '250px' }"></div>
						<div class="overlay"></div>
					</div>
					<!-- half-slider-img item end -->
					...
					<!-- half-slider-img item -->
					<div class="half-slider-img-item">
						<div class="bg" data-bg="{{ asset_url('client/images/bg/2.jpg') }}" data-scrollax="properties: { translateY: '250px' }"></div>
						<div class="overlay"></div>
					</div>
					<!-- half-slider-img item end -->
